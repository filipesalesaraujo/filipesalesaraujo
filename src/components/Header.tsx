  ...
  return (
    <Box bg={bg} borderBottom="1px" borderColor="gray.300">
      <Container w="100%" maxW="container.xl" p="5">
        ...
        >
          <Heading color={textColor} as="h1" size="xl">
            Filipe Sales Araujo
          </Heading>
          <Flex gap="5">
            <NavLink to="/" title="Home">
              <Button colorScheme="blue" variant={buttonVariant} size="lg">
                Home
              </Button>
            </NavLink>
        ...
        >
          <Menu>
            ...
            <MenuList>
              ...
              <MenuItem>
                <NavLink to="/tests" title="Studies">
                  Tests
                </NavLink>
              </MenuItem>
            </MenuList>
