            ...
            <main>
                <section className="flex justify-center items-center">
                    <div className="max-w-[1140px] w-[100%] p-5 gap-5 flex flex-col">
                        ...
                        <h2 className="text-3xl font-extrabold bg-gradient-linear bg-clip-text text-transparent">Implementação do kNN para Segmentação de Clientes no Banco Beta</h2>
                        ...
                        <h3 className="text-3xl font-extrabold bg-gradient-linear bg-clip-text text-transparent">Aprimorando a Personalização Bancária através da Segmentação de Clientes</h3>
                        ...
                        <p className="text-gray-300">AHA, D. W.; KIBLER, D.; ALBERT, M. K. <strong>Instance-based learning algorithms.</strong> Machine Learning, v. 6, n. 1, p. 37-66, 1991.</p>
                        <p className="text-gray-300">JAIN, A. K.; DUBES, R. C. <strong>Algorithms for clustering data.</strong> Englewood Cliffs: Prentice-Hall, Inc., 1988.</p>
                        <p className="text-gray-300">HASTIE, T.; TIBSHIRANI, R.; FRIEDMAN, J. <strong>The elements of statistical learning:</strong> data mining, inference, and prediction. New York: Springer Science & Business Media, 2009.</p>
                    </div>
                </section>
            </main>
        </div>
