            ...
            <main>
                <section className="flex justify-center items-center">
                    <div className="max-w-[1140px] w-[100%] p-5 gap-5 flex flex-col">
                        ...
                        <hr className="text-gray-300"/>
                        <p className="text-gray-300">BERNERS-LEE, T.; HENDLER, J.; LASSILA, O. The Semantic Web. Scientific American, v. 284, n. 5, p. 34-43, 2001.</p>
                        <p className="text-gray-300">SHADBOLT, N.; BERNERS-LEE, T.; HALL, W. The Semantic Web Revisited. IEEE Intelligent Systems, v. 21, n. 3, p. 96-101, 2006.</p>
                        <p className="text-gray-300">HITZLER, P.; KRÖTZSCH, M.; RUDOLPH, S. Foundations of Semantic Web technologies. 1ª ed. Boca Raton: CRC Press, 2009.</p>
                        <p className="text-gray-300">BIZER, C.; HEATH, T.; BERNERS-LEE, T. Linked Data - The Story So Far. International Journal on Semantic Web and Information Systems, v. 5, n. 3, p. 1-22, 2009.</p>
                    </div>
                </section>
            </main>
        </div>
