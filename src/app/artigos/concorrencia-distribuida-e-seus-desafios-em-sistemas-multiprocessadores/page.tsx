            ...
            <main>
                <section className="flex justify-center items-center">
                    <div className="max-w-[1140px] w-[100%] p-5 gap-5 flex flex-col">
                        ...
                        <hr className="text-gray-300"/>
                        <h2  className="text-gray-300 text-2xl">Race Conditions</h2>
                        ...
                        <hr className="text-gray-300"/>
                        <h3  className="text-gray-300 text-2xl">DeadLock</h3>
                        ...
                        <hr className="text-gray-300"/>
                        <h4 className="text-gray-300 text-2xl">LiveLock</h4>
                        ...
                        <hr className="text-gray-300"/>
                        <p className="text-gray-300">Tanenbaum, A. S., & Van Steen, M. (2007). <strong>Sistemas distribuídos:</strong> princípios e paradigmas. Prentice Hall. </p>
                        <p className="text-gray-300">Herlihy, M., & Shavit, N. (2011). <strong>The art of multiprocessor programming.</strong> Elsevier.</p>
                        <p className="text-gray-300">Silberschatz, A., Galvin, P. B., & Gagne, G. (2009). <strong>Operating system concepts.</strong> John Wiley & Sons.</p>
                    </div>
                </section>
            </main>
        </div>
