        ...
        <main>
            ...
            <section className="flex justify-center items-center">
                <div className="max-w-[1140px] w-[100%] p-5 gap-5 flex flex-col">
                    ...
                    <h3 className="text-gray-300 text-2xl">Técnicas de otimização para jogos de tabuleiro</h3>
                    ...
                    <hr className="text-gray-300"/>
                    <p className="text-gray-300">RUSSELL, S. J.; NORVIG, P. Artificial Intelligence: A Modern Approach. 3ª ed. Prentice Hall, 2010.</p>
                    <p className="text-gray-300">EIBEN, A. E.; SMITH, J. E. Introduction to Evolutionary Computing. Springer, 2015.</p>
                    <p className="text-gray-300">SIPSER, M. Introduction to the Theory of Computation. 3ª ed. Cengage Learning, 2012.</p>
                    <p className="text-gray-300">DECHTER, R.; PEARL, J. Generalized best-first search strategies and the optimality of A*. Journal of the Association for Computing Machinery, v. 32, n. 3, p. 505-536, 1985.</p>
                </div>
            </section>
        </main>
    )
