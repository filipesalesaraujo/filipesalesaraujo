            ...
            <main>
                <section className="flex justify-center items-center">
                    <div className="max-w-[1140px] w-[100%] p-5 gap-5 flex flex-col">
                        ...
                        <hr className="text-gray-300"/>
                        <p className="text-gray-300">BANKER, K. MongoDB in Action. Manning Publications Co., 2011.</p>
                        <p className="text-gray-300">HAN, J., PEI, J., KAMBER, M. Data Mining: Concepts and Techniques. 3ª ed. Morgan Kaufmann, 2011.</p>
                        <p className="text-gray-300">CHODOROW, K. MongoDB: The Definitive Guide. O&apos;Reilly Media, Inc., 2013.</p>
                    </div>
                </section>
            </main>
        </div>
