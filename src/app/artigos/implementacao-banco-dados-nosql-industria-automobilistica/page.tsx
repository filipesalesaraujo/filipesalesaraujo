...
export const metadata: Metadata = {
    ...
    description: 'Filipe Sales Araujo aborda a importância e os benefícios de implementar um banco de dados NoSQL, especificamente o MongoDB, na indústria automobilística. Saiba como essa solução pode lidar com a diversidade, complexidade e volume de dados da indústria, proporcionando flexibilidade, escalabilidade e alta disponibilidade.',
    keywords: 'Filipe Sales Araujo, Banco de Dados NoSQL, indústria automobilística, MongoDB, armazenamento de dados, escalabilidade, flexibilidade, alta disponibilidade, replicação, sharding, indústria 4.0'
}
