        ...
        <main>
            ...
            <section className="flex justify-center items-center">
                <div className="max-w-[1140px] w-[100%] p-5 gap-5 flex flex-col">
                    ...
                    <hr className="text-gray-300"/>
                    <p className="text-gray-300">BREIMAN, L. Statistical Modeling: The Two Cultures. Statistical Science, 16(3), 199-231, 2001.</p>
                    <p className="text-gray-300">HASTIE, T.; TIBSHIRANI, R.; FRIEDMAN, J. The Elements of Statistical Learning. Springer, 2009.</p>
                    <p className="text-gray-300">JAMES, G.; WITTEN, D.; HASTIE, T.; TIBSHIRANI, R. An Introduction to Statistical Learning. Springer, 2013.</p>
                    <p className="text-gray-300">HAND, D.J.; HENLEY, W.E. Statistical Classification Methods in Consumer Credit Scoring: a Review. Journal of the Royal Statistical Society. Series A (Statistics in Society), 160(3), 523-541, 1997.</p>
                    <p className="text-gray-300">BISHOP, C.M. Pattern Recognition and Machine Learning. Springer, 2006.</p>
                </div>
            </section>
        </main>
    )
