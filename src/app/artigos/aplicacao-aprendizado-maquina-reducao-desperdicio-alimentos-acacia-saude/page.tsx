            ...
            <main>
                <section className="flex justify-center items-center">
                    <div className="max-w-[1140px] w-[100%] p-5 gap-5 flex flex-col">
                        ...
                        <h1 className="text-3xl font-extrabold bg-gradient-linear bg-clip-text text-transparent">Aplicação do Aprendizado de Máquina Supervisionado na Redução do Desperdício de Alimentos na Rede Hospitalar Acácia Saúde</h1>
                        ...
                        <h2 className="text-3xl font-extrabold bg-gradient-linear bg-clip-text text-transparent">Métodos e Implementação do Aprendizado Supervisionado</h2>
                        ...
                        <h3 className="text-3xl font-extrabold bg-gradient-linear bg-clip-text text-transparent">Impacto e Perspectivas do Aprendizado de Máquina no Combate ao Desperdício na Saúde</h3>
                        ...
                        <p className="text-gray-300">ALPAYDIN, E. <strong>Introduction to Machine Learning.</strong> 3. ed. Cambridge, MA: MIT Press, 2020.</p>
                        <p className="text-gray-300">HASTIE, T.; TIBSHIRANI, R.; FRIEDMAN, J. <strong>The Elements of Statistical Learning:</strong> Data Mining, Inference, and Prediction. 2. ed. New York: Springer, 2009.</p>
                        <p className="text-gray-300">KELLEHER, J. D.; MAC NAMEE, B.; D&apos;ARCY, A. <strong>Fundamentals of Machine Learning for Predictive Data Analytics:</strong> Algorithms, Worked Examples, and Case Studies. Cambridge, MA: MIT Press, 2015.</p>
                        <p className="text-gray-300">RUSSELL, S. J.; NORVIG, P. <strong>Artificial Intelligence:</strong> A Modern Approach. 3. ed. Upper Saddle River, NJ: Prentice Hall, 2016.</p>
                        <p className="text-gray-300">SOKOLOVA, M.; LAPALME, G. <strong>A systematic analysis of performance measures for classification tasks.</strong> Information Processing & Management, v. 45, n. 4, p. 427-437, 2009.</p>
                    </div>
                </section>
            </main>
        </div>
