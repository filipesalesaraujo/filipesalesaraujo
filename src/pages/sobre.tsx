            ...
            <section className="max-w-7xl px-5 py-10 flex flex-wrap gap-10 flex-col ">
                ...
                <div className="flex gap-5 items-start flex-col md:flex-row">
                    <div className="flex flex-col gap-5 items-start">
                        ...
                        <p className="text-2xl">No âmbito técnico, escolhi usar o <strong>Next.js</strong> no front-end devido à sua eficiência e adaptabilidade. Para o back-end, optei pelo <strong>WordPress Headless</strong>, uma solução robusta e flexível que se integra perfeitamente ao conjunto, proporcionando um desempenho superior e uma experiência de usuário mais fluida.</p>
                    </div>
                </div>
            </section>
        </main>
