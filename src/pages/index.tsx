            ...
            <section className="max-w-7xl p-5 flex flex-wrap gap-10 flex-col ">
                ...
                <div className="flex gap-5 items-start flex-col md:flex-row">
                    <div className="flex md:w-1/2 flex-col gap-5">
                        <p className="text-lg">Desenvolvo websites que se destacam pela sua velocidade surpreendente, design responsivo e modernidade. Cada projeto é meticulosamente otimizado para garantir que os usuários tenham a melhor experiência possível, independentemente do dispositivo que estejam usando.</p>
                        <p className="text-lg">Meus sites não apenas impressionam visualmente, mas também em termos de desempenho. Eles consistentemente alcançam pontuações perfeitas no PageSpeed Insights, refletindo o comprometimento com a excelência técnica. Além disso, faço um monitoramento contínuo através do Google Search Console, garantindo que todos os links sejam corretamente indexados. Complementando essa análise, utilizo o Google Analytics 4 (GA4) para rastrear e entender o comportamento das visitas, proporcionando insights valiosos sobre a interação dos usuários com o conteúdo.</p>
                        <p className="text-lg">Opto por desenvolver utilizando o Next.js, uma das frameworks mais avançadas do mercado. A decisão de utilizar o Next.js não é apenas uma escolha técnica, mas também estratégica. Ele possibilita que os sites sejam altamente otimizados, facilmente escaláveis e com capacidade de integração a diversas ferramentas e plataformas, ampliando assim o potencial de qualquer projeto na web.</p>
                    </div>
